...
public class SelectDistinctIndexValuePropertyTests extends TestForAnnotationProperty<SelectDistinctIndexValueProperty> {
    @Mock
    private ExecutableElement element;
    @Mock
    private SelectDistinctIndexValue annotation;
    @Mock
    private Type type;
    @Mock
